...
namespace TestTexture
{
    ...
    TEST_MODULE_INITIALIZE(TestTextureModuleInit)
    {
        Logger::WriteMessage("TestTexture module initialization");
    ...
    TEST_MODULE_CLEANUP(TestTextureModuleCleanup)
    {
        Logger::WriteMessage("TestTexture module cleanup");
    ...
    public:
        TEST_METHOD(Test1)
        {
            ...
            ResourceManager::loadTexture("../../../Apocalypse/textures/OpenGL-test.png", true, "OpenGL-Logo");
        ...
        TEST_METHOD(Test2)
        {
            Logger::WriteMessage("Start TEST-2");
